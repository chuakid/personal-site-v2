...
For mining, I used to use mpvacious, but I've found [Memento](https://github.com/ripose-jp/Memento) easier to use. For Memento, you just have to setup the dictionaries and card fields for Lapis; pretty simple.
